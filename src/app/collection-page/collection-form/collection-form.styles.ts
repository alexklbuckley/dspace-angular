...
import { collectionFormEntityTypeSelectionConfig, administratorStyleFormModels, } from './collection-form.models';
...
export class CollectionStylesFormComponent extends ComColFormComponent<Collection> implements OnInit {
  /**
  ...
  ngOnInit() {
    ...
    entities$.subscribe((entityTypes: ItemType[]) => {
        ...
        this.formModel = [...administratorStyleFormModels];
